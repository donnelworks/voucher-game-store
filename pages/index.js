    ...
    <>
          ...
          <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
              <ul class="navbar-nav ms-auto text-lg gap-lg-0 gap-2">
                ...
                <li class="nav-item my-auto">
                  <a
                    class="btn btn-sign-in d-flex justify-content-center ms-lg-2 rounded-pill"
        ...
        <div class="container-xxl container-fluid">
          <div class="row gap-lg-0 gap-5">
            <div class="col-lg-6 col-12 my-auto">
              <p class="text-support text-lg color-palette-2">Halo gamers,</p>
              <h1 class="header-title color-palette-1 fw-bold">
                Topup & Get <span class="d-sm-inline d-none">a</span>
                <span class="d-sm-none d-inline">a</span>
                <span class="underline-blue"> New</span>{" "}
                <br class="d-sm-block d-none" />{" "}
                <span class="underline-blue">Experience</span> in Gaming
              </h1>
              <p class="mt-30 mb-40 text-lg color-palette-1">
                Kami menyediakan jutaan cara untuk membantu
                <br class="d-md-block d-none" /> players menjadi pemenang sejati
              </p>
              ...
              <div class="d-flex justify-content-lg-end justify-content-center me-lg-5">
                <div class="position-relative" data-aos="zoom-in">
                  ...
                  <div class="card right-card position-absolute border-0">
                    ...
                    <div>
                      <p class="text-sm text-center m-0 fw-medium color-palette-1">
                        Lann Knight
                      </p>
                      <p class="fw-light text-center m-0 color-palette-2 text-xs">
                        Dota 2
                      </p>
                    </div>
                  </div>
      ...
      <section class="featured-game pt-50 pb-50">
        <div class="container-fluid">
          ...
          <div
            class="d-flex flex-row flex-lg-wrap overflow-setting justify-content-lg-between gap-lg-3 gap-4"
            data-aos="fade-up"
          >
      ...
      <section class="reached pt-50 pb-50">
        <div class="container-fluid">
          <div class="d-flex flex-lg-row flex-column align-items-center justify-content-center gap-lg-0 gap-4">
            <div class="me-lg-35">
              <p class="text-4xl text-lg-start text-center color-palette-1 fw-bold m-0">
                290M+
              </p>
      ...
      <section class="story pt-50 pb-50">
        <div class="container-xxl container-fluid">
          <div class="row align-items-center px-lg-5 mx-auto gap-lg-0 gap-4">
            <div
              class="col-lg-7 col-12 d-lg-flex d-none justify-content-lg-end pe-lg-60"
              data-aos="zoom-in"
            >
              <img
            ...
            <div class="col-lg-5 col-12 ps-lg-60">
              <div class="">
                ...
                <p class="text-lg color-palette-1 mb-30">
                  ...
                  <br class="d-sm-block d-none" /> pemenang sejati
                </p>
